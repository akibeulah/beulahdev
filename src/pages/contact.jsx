                ...
                <div className="flex flex-col">
                    <div className="mb-4 w-full">
                        <input type="text" placeholder={"Fullname"} value={formData.from_name}
                            ...
                            className={"bg-transparent border  p-2 px-4 rounded  w-full border-[#e3e3e3] placeholder:text-[#e3e3e3] outline-none"} />
                    </div>
                    <div className="mb-4 w-full">
                    ...
                    <div className="w-full mb-4">
                        <textarea placeholder={"Message"} value={formData.message}
                            ...
                            className={"bg-transparent border  p-2 px-4 rounded w-full block border-[#e3e3e3] placeholder:text-[#e3e3e3] outline-none"} />
                    </div>

                    <button
                        className={"flex flex-row items-center py-2 px-3 border border-[#e3e3e3] w-fit hover:bg-[#10549f] hover:text-[#e3e3e3] hover:border-[#6ac9eb] duration-300"}>
                        <span>Send</span>
